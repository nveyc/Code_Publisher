...
namespace CppCliWindows
{
  ref class WPFCppCliDemo : Window
  {
    ...
    Button^ hDemoButton = gcnew Button();
	...
	Label^ fileLable = gcnew Label();
	Label^ categoryLable = gcnew Label();
	...
	Button^ hShowCatagoryButton = gcnew Button();
	Button^ hShowFileinCatagoryButton = gcnew Button();
	Button^ hAnalysisButton = gcnew Button();
	Button^ hDisplayhtmlButton = gcnew Button();
	Button^ hDownloadButton = gcnew Button();
	Button^ hShowNoParentFile = gcnew Button();
  ...
  public:
	...
	void Demo(Object^ sender, RoutedEventArgs^ args);
	...
	//repository view
	void AnalyzeRepo(Object^ sender, RoutedEventArgs^ args);
	void ShowAllCatagory(Object^ sender, RoutedEventArgs^ args);
	void UploadFile(Object^ sender, RoutedEventArgs^ args);
	void ShowFilesInCatagory(Object^ sender, RoutedEventArgs^ args);
	void ShowFilesWithNP(Object ^ sender, RoutedEventArgs ^ args);
  ...
  private:
	...
	void setUploadRomAndCol();
	void setUpLoadButtoms();

	void setUpRepoRomAndCol();
	void sethAnalysisButton();
	void sethShowCatagoryButton();
	void sethShowFileinCatagoryButton();
	void sethDisplayhtmlButton();
	void sethDownloadButton();
	void sethShowNoParentFile();
	void sethDeleteButton();
